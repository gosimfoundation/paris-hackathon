...
const criteria = [
  { name: 'Innovation', desc: 'Originality and novelty of the idea', color: 'bg-accent-red', icon: '01' },
  ...
  { name: 'Practicality', desc: 'Real-world problem-solving potential', color: 'bg-accent-cyan', icon: '04' },
  { name: 'Presentation', desc: 'Clarity and persuasiveness of the demo', color: 'bg-accent-red', icon: '05' },
]
  ...
  <section id="judging" class="relative py-32 bg-bg-secondary overflow-hidden">
    <div class="max-w-4xl mx-auto px-6">
      ...
      <div class="space-y-6">
        ...
        >
          <span class="text-2xl font-mono font-bold text-white/20 shrink-0">{{ c.icon }}</span>
