  ...
  <section class="relative py-32 bg-bg-secondary overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-6 text-center reveal">
      <h2 class="text-4xl md:text-5xl font-bold mb-6">
        Build the Future of <span class="heading-serif accent-text">Agentic AI</span>
      </h2>
      <p class="text-text-secondary text-lg mb-4">
        Applications are open to developers and teams worldwide.
      </p>
