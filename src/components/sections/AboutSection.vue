  ...
  <section id="about" class="relative py-32 bg-bg-primary particles overflow-hidden">
    <div class="max-w-4xl mx-auto px-6">
      <div class="text-center reveal">
        <span class="text-accent-cyan text-sm font-semibold uppercase tracking-wider">Beyond Chat Interfaces</span>
        ...
        <p class="text-text-secondary text-lg leading-relaxed mb-8">
          ...
          <span class="text-white font-semibold">reason</span>,
          <span class="text-white font-semibold">plan</span>,
          <span class="text-white font-semibold">use tools</span>,
          <span class="text-white font-semibold">interact with systems</span>,
          and <span class="text-white font-semibold">collaborate with other agents</span> to accomplish tasks.
        </p>
