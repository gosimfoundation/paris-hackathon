      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div class="flex items-center gap-3 mb-2">
            <img :src="assetUrl(user.avatar) || '/default-avatar.svg'" class="w-10 h-10 rounded-full shrink-0 object-cover border border-border" />
            <div class="min-w-0">
        ...
        <div v-if="showUserModal && viewingUser" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div class="relative w-full max-w-lg glass-card p-8 max-h-[90vh] overflow-y-auto border-accent-red/20">
            ...
            <div class="flex items-center gap-4 mb-6">
              <img :src="assetUrl(viewingUser.avatar) || '/default-avatar.svg'" class="w-16 h-16 rounded-full object-cover border border-border" />
              <div>
            ...
            <div v-if="getUserTeam(viewingUser)" class="p-4 bg-bg-elevated">
              ...
              <div class="flex items-center gap-3">
                <img :src="assetUrl(getUserTeam(viewingUser)!.avatar) || '/default-avatar.svg'" class="w-8 h-8 rounded-full object-cover border border-border" />
